...
def visual():
    ...
    pacman = pygame.image.load("../image/pacman.png")
    pacman = pygame.transform.scale(pacman, (tile_size - 4, tile_size - 4))
    ...
    power_pellets = [(1, 1), (len(maze[0]) - 2, 1),
                     (1, len(maze) - 2),
    ...
    while run:
        ...
        if show_maze:
            ...
            screen.blit(pacman, (pacman_col * tile_size + 2, pacman_row * tile_size + 2))
